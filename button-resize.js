document.addEventListener("DOMContentLoaded", function(){
    ...
    document.getElementById('no2').addEventListener('click', function() {
        document.getElementById('gif').src = 'imgs/sad-wher.gif';  // Change to a second GIF
    ...
    document.getElementById('yes2').addEventListener('click', function() {
        ...
        document.getElementById('gif').src = 'imgs/dancing.gif';

        document.body.style.backgroundImage = "url('imgs/confetti.gif')";        document.getElementById('sad').style.display = 'none';  // Show more text
